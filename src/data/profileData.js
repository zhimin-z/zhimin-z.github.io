...
export const openSource = [
  ...
  { title: 'General Physical Intelligence', role: 'Initiator', kind: 'organization', desc: 'An open-source organization advancing foundation models, agents, and systems for general physical intelligence.', url: 'https://github.com/General-Physical-Intelligence' },
  ...
  { title: 'AI4Maths', role: 'Initiator', kind: 'organization', desc: 'An effort to accelerate mathematical research with transparent, reproducible, and AI-powered methods.', url: 'https://github.com/AI4Maths' },
  ...
  { title: 'MathNetwork', role: 'Contributor', kind: 'organization', desc: 'An organization exploring how mathematical knowledge is produced, stored, and organized, currently building Riemannian geometry as a living, machine-verified textbook.', url: 'https://github.com/MathNetwork' },
  ...
  { title: 'NISP Cybersecurity', role: 'Contributor', kind: 'organization', desc: "A Queen's University research lab working at the intersection of machine learning, cybersecurity, and privacy, spanning AI security, generative AI safeguards, watermarking, and autonomous agent systems.", url: 'https://github.com/NISP-Cybersecurity' }
]
