...
export const blogs = [
  { badge: "Medium", title: 'How Robots Decide What to Do Next: From Technical Approaches to a Decision Map', venue: 'Medium, Aug 2026.', links: [{ label: 'blog', url: 'https://medium.com/@zhiminzhao/how-robots-decide-what-to-do-next-from-technical-approaches-to-a-decision-map-91e1722b5706' }] },
...
export const openSource = [
  { title: 'Engineered AI', role: 'Initiator', group: 'Organization', kind: 'organization', desc: 'An open collective developing engineering practices, benchmarks, and reusable systems for building reliable AI-powered software.', url: 'https://github.com/Engineering4AI' },
  { title: 'General Physical Intelligence', role: 'Initiator', group: 'Organization', kind: 'organization', desc: 'An open-source organization advancing foundation models, agents, and systems for general physical intelligence.', url: 'https://github.com/General-Physical-Intelligence' },
  { title: 'AI4Scientist', role: 'Initiator', group: 'Organization', kind: 'organization', desc: 'An open effort exploring how AI agents and foundation models accelerate scientific discovery across disciplines.', url: 'https://github.com/AI4Scientist' },
  { title: 'AI4Maths', role: 'Initiator', group: 'Organization', kind: 'organization', desc: 'An effort to accelerate mathematical research with transparent, reproducible, and AI-powered methods.', url: 'https://github.com/AI4Maths' },
  { title: 'Solo Entrepreneur', role: 'Initiator', group: 'Organization', kind: 'organization', desc: 'A community initiative building open tools, playbooks, and shared infrastructure for independent founders operating at AI-native scale.', url: 'https://github.com/Solo-Entrepreneur' },
  { title: 'MathNetwork', role: 'Contributor', group: 'Organization', kind: 'organization', desc: 'An organization exploring how mathematical knowledge is produced, stored, and organized, currently building Riemannian geometry as a living, machine-verified textbook.', url: 'https://github.com/MathNetwork' },
  { title: 'EthicalML', role: 'Maintainer', group: 'Organization', kind: 'organization', desc: 'A community building open-source tools and curated resources for responsible, production-grade machine learning.', url: 'https://github.com/EthicalML' },
  { title: 'NISP Cybersecurity', role: 'Contributor', group: 'Organization', kind: 'organization', desc: "A Queen's University research lab working at the intersection of machine learning, cybersecurity, and privacy, spanning AI security, generative AI safeguards, watermarking, and autonomous agent systems.", url: 'https://github.com/NISP-Cybersecurity' },
  { title: 'Software Engineering Arena', role: 'Initiator', group: 'Organization', kind: 'organization', desc: 'An open-source organization building an interactive platform for evaluating foundation models in software engineering through community-driven pairwise comparisons and Elo-based ranking.', url: 'https://github.com/SE-Arena/Software-Engineer-Arena' },
  { title: 'Learn World Model', role: 'Initiator', group: 'Project', kind: 'tutorial', desc: 'A hands-on tutorial for understanding and building world models, covering the core concepts, architectures, and training techniques behind model-based agents and video generation.', url: 'https://github.com/datawhalechina/learn-world-model' },
  { title: 'Hello Claw', role: 'Initiator', group: 'Project', kind: 'tutorial', desc: 'A comprehensive tutorial for adopting and customizing OpenClaw, an AI command-line assistant, covering both practical usage and technical implementation from scratch.', url: 'https://github.com/datawhalechina/hello-claw' },
  { title: 'AnyCLI', role: 'Initiator', group: 'Project', kind: 'project', desc: 'A unified registry and capability-dispatch layer that lets AI agents discover, install, and safely invoke CLI tools through a single standardized interface.', url: 'https://github.com/datawhalechina/anycli' },
  { title: 'Learn Auto Research', role: 'Initiator', group: 'Project', kind: 'tutorial', desc: 'A hands-on open-source project for learning how to build and run AI-powered automated research workflows end to end.', url: 'https://github.com/AI4Scientist/learn-auto-research' },
  { title: 'Awesome AI Leaderboards', role: 'Initiator', group: 'Project', kind: 'project', desc: 'A curated list of AI leaderboards, development tools, and evaluation organizations compiled from a comprehensive survey of the leaderboard ecosystem.', url: 'https://github.com/SAILResearch/awesome-foundation-model-leaderboards' },
  { title: 'Easy-Pocket', role: 'Initiator', group: 'Project', kind: 'tutorial', desc: 'An interactive tutorial for PocketFlow, teaching developers to build chatbots, RAG systems, agents, and workflows using minimal LLM application framework abstractions.', url: 'https://github.com/datawhalechina/easy-pocket' }
]
