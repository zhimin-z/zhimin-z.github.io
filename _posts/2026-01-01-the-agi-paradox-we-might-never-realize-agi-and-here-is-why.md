...
**Even most AI experts commit this fallacy.** Psychologists recognize [eight major types of human intelligence](https://www.simplypsychology.org/multiple-intelligences.html): musical, visual-spatial, linguistic, logical-mathematical, bodily-kinesthetic, interpersonal, intrapersonal, and naturalistic intelligence. No single person masters all eight. Consider an extreme case: would we deny the label of "human intelligence" to someone paralyzed and autistic simply because they lack bodily-kinesthetic and interpersonal intelligence? Of course not. Yet this is precisely the double standard we apply to AI. For example, LLMs (large language models) possess exceptional capabilities in linguistic and logical-mathematical intelligence while having virtually no bodily-kinesthetic, interpersonal, or naturalistic intelligence.** Instead of acknowledging these systems have achieved genuine competence in multiple domains, we evaluate them against a composite ideal of human intelligence that no individual human actually embodies, then declare AI inadequate for failing to match this fictional standard.
