...
Even most AI experts commit this fallacy. The "general" in AGI supposedly means matching human general intelligence—yet we've never clearly defined what that means. Psychologists recognize eight major types of human intelligence: [musical, visual-spatial, linguistic, logical-mathematical, bodily-kinesthetic, interpersonal, intrapersonal, and naturalistic intelligence](https://www.simplypsychology.org/multiple-intelligences.html). Consider an extreme case: would we deny the label of "general intelligence" to someone paralyzed and autistic simply because they lack bodily-kinesthetic and interpersonal intelligence? Of course not—we recognize they possess general intelligence despite missing several types. Yet this is precisely the double standard we apply when evaluating AGI. **LLMs (large language models) possess exceptional capabilities in linguistic and logical-mathematical intelligence while having virtually no bodily-kinesthetic, interpersonal, or naturalistic intelligence.** Instead of acknowledging these systems have achieved competence comparable to humans in multiple domains, we evaluate them against a composite ideal that no individual human actually embodies, then declare them inadequate for failing to match this fictional standard.
