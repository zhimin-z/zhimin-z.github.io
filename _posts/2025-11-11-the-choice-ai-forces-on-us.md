...
If AI continues under the logic of unrestrained capitalism, we inch toward a future imagined by **Cixin Liu** in [For the Benefit of Mankind](https://en.wikipedia.org/wiki/For_the_Benefit_of_Mankind). In Liu's tale, a distant civilization experiences a **technological explosion**—the ability to store knowledge directly in the brain—that creates an insurmountable cognitive gap between classes. Combined with unchecked capitalism, this leads to all wealth concentrating in a single being: the **Last Capitalist**, who owns everything, even the planet's raw materials-the land, the seas, and the air, all protected by robots. In this world, breathable air itself must be purchased. Those who cannot pay are forced to **harvest their own bodies for raw materials** while the planet's resources remain untouched, hoarded. The survivors eventually flee as refugees, driven from their own world.

Why does this scenario feel so plausible today? Because AI changes the fundamental economics of power. Traditional capitalism required labor to extract value. Exploitation was expensive—you needed people. But AI scales infinitely. It compounds wealth without workers. It doesn't need to exploit anyone—it simply makes them unnecessary. And here's the paradox: the same technology that promises to create "**sovereign individuals**"—where one person plus a data center can build an empire—also paves the straightest path to the Last Capitalist. In an unregulated system, AI doesn't democratize power; it **concentrates** it. The first movers accumulate exponentially more. What begins as radical individual empowerment ends in total consolidation. The result is **artificial scarcity amid abundance**: resources exist, but ownership hoards them beyond reach.
...
Yet, as comforting as it sounds, these safeguards **don't address** the economic dystopia of the "Last Capitalist." They prevent extinction, not inequality.
